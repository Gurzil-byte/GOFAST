...
#Tool Fixed in : 15:33 27/09/2019
...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct Gurzil AS u LIKE !\033[00m")
...
def aron():
 try:
  if os.name=='nt':
   os.system('cls && cd GOFAST && smtp.py')
  else:
   os.system('clear && cd GOFAST && python2 smtp.py')
 except:
    print("\033[91mERROR :| \nConatct Gurzil AS u LIKE !\033[00m")
to_check={}
...
<body>
	<center>
		<br><br><br>
		<h1>[ > ]New Smtp Cracker V3.0 [ < ]</h1> <br>
		<font color="#f16f6f"><h1>[ ! ]Developped by Gurzil [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Email :</font> Gurzil@t-online.de <br><br></font>
		<font color="black" size="5" ><font color="red">Youtube :</font> <a href="https://www.youtube.com/">Click HEre</a><br><br></font>
		<h2>© Gurzil 2017-2019</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
			rez=s.recv(1000)
...
print('''
 ...
 __\( X )/__   \033[93m$$ \__$$/ $$$  \ /$$$ |   $$ |   $$ |__$$ |  \033[0;96m__\( X )/__ 
(_.-/'-'\-._)  \033[93m$$      \ $$$$  /$$$$ |   $$ |   $$    $$/  \033[0;96m(_.-/'-'\-._)
   || i ||      \033[93m$$$$$$  |$$ $$ $$/$$ |   $$ |   $$$$$$$/      \033[0;96m|| i ||
 _.' `-' '._   \033[93m/  \__$$ |$$ |$$$/ $$ |   $$ |   $$ |        \033[0;96m_.' `-' '._  
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.) 
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
               \033[91m[\033[92m+\033[91m]\033[1m(C)opyright > Github.com/Gurzil\033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V3.0 MODIFIED BY Gurzil \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m     EMail : Gurzil@t-online.de    \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m Facebook >  https://www.fb.com/Gurzil \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Youtube > youtube.com/Gurzil  \033[91m[\033[92m+\033[91m]''')
...
if vers=='2.1':
 ...
 if ok=='1':
  ...
  os.system('git clone https://github.com/Gurzil-byte/GOFAST && cd GOFAST')
  if os.name=='nt':
   os.system('cls')
  else:
   os.system('clear')
